    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta
            name="description"
            content="The starting point for your next project with %PROJECT_TITLE% Kit, built on the newest version of Material-UI ©, ready to be customized to your style"
          />
          <meta name="keywords" content="react,material,kit,application,dashboard,admin,template" />
          <meta name="author" content="%PROJECT_TITLE% Kit" />
        </Head>
