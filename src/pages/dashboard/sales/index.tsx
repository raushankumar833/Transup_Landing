...
// import WalletCurrentBalance from 'src/sections/@dashboard/general/app/WalletCurrentBalance';
...
export default function GeneralAppPage() {
  ...
  return (
    <RoleBasedGuard hasContent roles={[USERROLES.asm, USERROLES.zsm]}>
      <>
        <Head>
        ...
        <Container maxWidth={themeStretch ? false : 'xl'}>
          <Grid container spacing={3}>
            <Grid item xs={12} md={8}>
              <AppWelcome
                title={`Welcome back! \n ${user?.name}`}
                description="Enjoy our rapid and secure services"
                img={
                  <SeoIllustration
                    sx={{
                      p: 3,
